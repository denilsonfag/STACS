...
RealMatrix::RealMatrix(){
    matrix_file_name = "data/costs.txt";
...
void RealMatrix::load_real_distance_matrix(int selected_id_work_day, DoubleMatrix* &real_distance_matrix){
    matrix_file.close();
    matrix_file.open(matrix_file_name, ios::in);
    bool flag = true;
...
void RealMatrix::load_real_time_matrix(int selected_id_work_day, DoubleMatrix* &real_time_matrix){
    matrix_file.close();
    matrix_file.open(matrix_file_name, ios::in);
    bool flag = true;
    while (flag) {  // lendo todo o arquivo das matrizes
