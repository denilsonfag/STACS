 ...
 */
    ...
    class ServiceOrder {
        ...
        bool executed;
        double total_time_execution_real_solution;
        double total_time_execution_proposed_solution;
    ...
    public:
        ...
        void set_executed_service(double partial_route_temporal_cost);
        ...
        void set_total_time_execution_real_solution(double partial_route_cost);
