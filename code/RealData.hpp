...
// classe para acesso aos arquivos de dados reais
    ...
    // o arquivo data.txt possui os dados reais utilizados no experimento
    class RealData{
        int depot;
    ...
    public:
        ...
        void load_ids_work_days(IntList* &list_id_work_days, int n_work_days);  // carregas as ids dos dias no vetor
        ...
        int x_depot();
        int y_depot();
        void load_real_solution(int selected_id_work_day, MtspSolution* &real_solution, MtspInstance* &instance, ServiceOrder* &day_services);
    };
