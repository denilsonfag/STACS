...
${OBJECTDIR}/code/AcoMtspAlgorithm.o: code/AcoMtspAlgorithm.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/code/AcoMtspAlgorithm.o code/AcoMtspAlgorithm.cpp

${OBJECTDIR}/code/AcsAlgorithm.o: code/AcsAlgorithm.cpp 
	${MKDIR} -p ${OBJECTDIR}/code
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/code/AcsAlgorithm.o code/AcsAlgorithm.cpp

${OBJECTDIR}/code/Ant.o: code/Ant.cpp 
	${MKDIR} -p ${OBJECTDIR}/code
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/code/Ant.o code/Ant.cpp

${OBJECTDIR}/code/Colony.o: code/Colony.cpp 
	${MKDIR} -p ${OBJECTDIR}/code
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/code/Colony.o code/Colony.cpp

${OBJECTDIR}/code/DoubleMatrix.o: code/DoubleMatrix.cpp 
	${MKDIR} -p ${OBJECTDIR}/code
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/code/DoubleMatrix.o code/DoubleMatrix.cpp

${OBJECTDIR}/code/EuclideanGraph.o: code/EuclideanGraph.cpp 
	${MKDIR} -p ${OBJECTDIR}/code
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/code/EuclideanGraph.o code/EuclideanGraph.cpp

${OBJECTDIR}/code/IntList.o: code/IntList.cpp 
	${MKDIR} -p ${OBJECTDIR}/code
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/code/IntList.o code/IntList.cpp

${OBJECTDIR}/code/Intersection.o: code/Intersection.cpp 
	${MKDIR} -p ${OBJECTDIR}/code
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/code/Intersection.o code/Intersection.cpp

${OBJECTDIR}/code/LocalSearch.o: code/LocalSearch.cpp 
	${MKDIR} -p ${OBJECTDIR}/code
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/code/LocalSearch.o code/LocalSearch.cpp

${OBJECTDIR}/code/MtspInstance.o: code/MtspInstance.cpp 
	${MKDIR} -p ${OBJECTDIR}/code
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/code/MtspInstance.o code/MtspInstance.cpp

${OBJECTDIR}/code/MtspNearestNeighbor.o: code/MtspNearestNeighbor.cpp 
	${MKDIR} -p ${OBJECTDIR}/code
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/code/MtspNearestNeighbor.o code/MtspNearestNeighbor.cpp

${OBJECTDIR}/code/MtspSolution.o: code/MtspSolution.cpp 
	${MKDIR} -p ${OBJECTDIR}/code
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/code/MtspSolution.o code/MtspSolution.cpp

${OBJECTDIR}/code/Node.o: code/Node.cpp 
	${MKDIR} -p ${OBJECTDIR}/code
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/code/Node.o code/Node.cpp

${OBJECTDIR}/code/Random.o: code/Random.cpp 
	${MKDIR} -p ${OBJECTDIR}/code
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/code/Random.o code/Random.cpp

${OBJECTDIR}/code/RealData.o: code/RealData.cpp 
	${MKDIR} -p ${OBJECTDIR}/code
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/code/RealData.o code/RealData.cpp

${OBJECTDIR}/code/RealExperiment.o: code/RealExperiment.cpp 
	${MKDIR} -p ${OBJECTDIR}/code
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/code/RealExperiment.o code/RealExperiment.cpp

${OBJECTDIR}/code/RealMatrix.o: code/RealMatrix.cpp 
	${MKDIR} -p ${OBJECTDIR}/code
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/code/RealMatrix.o code/RealMatrix.cpp

${OBJECTDIR}/code/Route.o: code/Route.cpp 
	${MKDIR} -p ${OBJECTDIR}/code
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/code/Route.o code/Route.cpp

${OBJECTDIR}/code/ServiceOrder.o: code/ServiceOrder.cpp 
	${MKDIR} -p ${OBJECTDIR}/code
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/code/ServiceOrder.o code/ServiceOrder.cpp

${OBJECTDIR}/code/StandardExperiment.o: code/StandardExperiment.cpp 
	${MKDIR} -p ${OBJECTDIR}/code
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/code/StandardExperiment.o code/StandardExperiment.cpp

${OBJECTDIR}/code/TacoAlgorithm.o: code/TacoAlgorithm.cpp 
	${MKDIR} -p ${OBJECTDIR}/code
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/code/TacoAlgorithm.o code/TacoAlgorithm.cpp

${OBJECTDIR}/code/Utilities.o: code/Utilities.cpp 
	${MKDIR} -p ${OBJECTDIR}/code
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/code/Utilities.o code/Utilities.cpp

${OBJECTDIR}/code/WorkDay.o: code/WorkDay.cpp 
	${MKDIR} -p ${OBJECTDIR}/code
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/code/WorkDay.o code/WorkDay.cpp
